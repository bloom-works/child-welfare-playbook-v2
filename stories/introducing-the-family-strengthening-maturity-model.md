...
* **Community partnerships.** How your agency works with external partners to build a system of resources that meet the needs of families in your jurisdiction. 
* **Family engagement.** How your agency builds trust with families, supports their needs and goals, and includes them in decision-making.

### Who the maturity model is for

This model is for any agency that wants to move away from a reactive and punitive approach to child welfare, toward an approach that’s more proactive and oriented to keeping families together. 

The staff survey is intended for child welfare staff across an entire agency, not just the teams responsible for prevention work. To set up the survey and build a roadmap using the results, you’ll need full participation, buy-in, and advocacy from your agency leadership.

### What’s included in the maturity model toolkit

Our [family strengthening maturity model toolkit](https://drive.google.com/drive/folders/15ZlpaJR2RvpXWJfiTMMIyYLhlElXsMv9) has all the resources you’ll need to implement the maturity model in your agency:
